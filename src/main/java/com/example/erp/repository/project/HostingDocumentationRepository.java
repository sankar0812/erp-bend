...
public interface HostingDocumentationRepository extends JpaRepository<HostingDocumentation, Long> {
	
	
	
	
	@Query(value = "select r.hosting_documentation_id as hostingDocumentationId ,r.accepted,r.date,r.employee_id as employeeId,"
			...
			+ "			 from  hosting_documentation as r"
